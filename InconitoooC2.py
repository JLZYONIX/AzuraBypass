...
correct_username ="root"#line:62
correct_key ="incothebest@"#line:63
...
╚═╝╚═╝  ╚═══╝ ╚═════╝ ╚═════╝ ╚═╝  ╚═══╝╚═╝   ╚═╝    ╚═════╝  ╚═════╝  ╚═════╝      ╚═════╝╚══════╝
                             ...
                             Time Remaining: inf   Logged as: InconitoooCFX 
    """#line:82
    additional_text ="""
    [$] Made by InconitoooCFX
    [$] Special botnet
    """#line:89
    help_text ="""
    Help:
    ...
    print_centered_colored_text (text ,Fore .BLUE )#line:105
    ...
    while True :#line:111
        user_input =input (Fore .RED +"InconitoooC2 >> "+Style .RESET_ALL )#line:112
